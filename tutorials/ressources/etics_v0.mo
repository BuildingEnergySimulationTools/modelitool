model etics_v0
  ...
  Modelica.Blocks.Sources.CombiTimeTable Boundaries(columns = 2:7, fileName = "C:/Users/thubert/PycharmProjects/modelitool/tutorials/ressources/boundary_temp.txt", tableName = "table1", tableOnFile = true) annotation(
